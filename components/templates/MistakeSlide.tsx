...
import type { Brand, MistakeSlide } from "@/lib/schema";
...
type MistakeSlideTemplateProps = {
  slide: MistakeSlide;
  brand?: Brand;
};

export function MistakeSlideTemplate({
  slide,
  brand,
}: MistakeSlideTemplateProps) {
    ...
    <div className="relative h-full w-full overflow-hidden bg-black text-white">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 px-12 pb-14 pt-8">
        ...
        <div className="mb-8 text-center">
          ...
          <p
            className="font-[family-name:var(--font-bebas)] text-[110px] leading-[0.95] tracking-wide"
